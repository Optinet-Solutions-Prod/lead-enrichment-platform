  ...
  return (
    <section className="rounded-lg border border-[color:var(--color-border)] bg-[color:var(--color-bg-secondary)] p-3">
      ...
      <p className="mt-1.5 text-[11px] leading-snug text-[color:var(--color-text-secondary)]">
        ...
        then flags likely affiliates and mines affiliate S-tags from the video descriptions — surfacing likely
        affiliates as <strong className="font-medium">new leads</strong>. Both are re-runnable.
      </p>
